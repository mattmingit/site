...
<img src="./img/projects/geted-main.jpg" className="rounded-[10px]" />
...
The project is currently offline, but once it'll be online again you can have a look at geted.it or geted.eu.
...
<img
  src="./img/project-page/geted/geted-phone.jpg"
